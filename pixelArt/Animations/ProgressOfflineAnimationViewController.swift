//
//  ProgressOfflineAnimationViewController.swift
//  pixelArt
//
...
class ProgressOfflineAnimationViewController: UIViewController, PixelViewDelegate, ColorPickerControlDelegate, AnimationControlDelegate {
    ...
    func goLeftAnimation() {
        ...
        colors = pageColors[pagePosition - 1]
        positions = pagePositions[pagePosition - 1]
    ...
    func goRightAnimation() {
        ...
        viewHolder.pixelView.colorsToDraw.removeAll()
        viewHolder.pixelView.positionsToDraw.removeAll()
        if (pagePositions.count > pagePosition + 1) {
            colors = pageColors[pagePosition + 1]
            positions = pagePositions[pagePosition + 1]
        } else {
        colors.removeAll()
    ...
    private func saveDrawing() {
        ...
        AnimationDataset.editEntry(atIndex: index, newEntry: entry)
    }
