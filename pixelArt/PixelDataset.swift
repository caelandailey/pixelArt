...
protocol PixelDatasetDelegate: class {
    var delegateID: String { get}
    func datasetUpdated()
}

// The actual data configuration
final class PixelDataset {
    ...
    private static func loadData() -> [Entry] {
        ...
        guard
            let fileURL: URL = try? FileManager.default.url(for: .documentDirectory, in: .userDomainMask, appropriateFor: nil, create: true).appendingPathComponent("PixelDataset.json", isDirectory: false),
